        ...
        return (
            <section>
                ...
                <div class="certificates">
                    <a href="https://drive.google.com/file/d/1doZHiakeg2t7IN8Tf-3ObWSVQd0ROczN/view?usp=sharing" target="_blank" rel="noopener noreferrer" id="certificate1">
                    ...
                    <div className="dots">
                        <span onClick={() => this.handleClick("certificate1")} class="dot" id="dot1"></span>
                        <span onClick={() => this.handleClick("certificate2")} class="dot" id="dot2"></span>
